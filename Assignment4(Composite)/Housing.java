...
public class Housing implements IStructure{
    private ArrayList <IStructure> structures; // for traversing through the components of a composite object
    ...
    public int addStructure(IStructure component){  //ArrayList is changed by public addStructure method
